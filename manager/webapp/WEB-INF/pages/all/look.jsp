						...
						<div class="data">
							...
							<table class="dataTable">
								<tr class="dataTableAddTd">
									...
									<td align="left">托运人（签字）姓名：${consignment.signShipper }</td>
								</tr>
								<tr>
									<td align="left">承运人（签字）姓名：${consignment.signCarrier }</td>
								</tr>
								<tr>
									<td align="left">收货人（签字）姓名：${consignment.signConsignee }</td>
								</tr>
								<tr>
									<td align="left">收&nbsp;获&nbsp;日&nbsp;期：<fmt:formatDate
											value="${consignment.signDatetime }" pattern="yyyy-MM-dd" />
									</td>
								</tr>
							</table>
						</div>
