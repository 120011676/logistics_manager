				...
				<div id="content-table-inner">
					<div class="data">
						...
						<table class="dataTable" style="margin-top: 5px;">
							...
							<tr>
								<td>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：<input
									name="" type="text" class="btn" style="width: 480px;"></td>
								<td>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：<input
									name="" type="text" class="btn" style="width: 480px;"></td>
							</tr>
							<tr>
						...
						<table class="dataTable">
							<tr class="dataTableAddTd">
								...
								<td colspan="3" align="left" width="50px">计费方式：<input
									name="" type="text" class="btn" style="width: 100px;"></td>
								<td align="left" width="200px">单价：<input name=""
									type="text" class="btn" style="width: 100px;"></td>
							</tr>
							<tr>
								<td><input name="" type="text" class="btn"
						...
						<div style="margin-top: 15px;">
							<input class="form-submit" style="margin-left: 45%;" type="button" value="">
						</div>
						</center>
					</div>
				</div>
